...
<body class="bg-slate-800 text-white">
    ...
    <div class="h-14 flex items-start justify-center mt-6">
        <h1 class="text-4xl">Agregar objetos a la orden interna</h1>
    </div>
            ...
            <table class="w-full">
                <thead class="border-y-2 border-gray-200">
                    <tr>
                        ...
                        <th class="p-3 tracking-wide text-left border-r border-gray-200">Información</th>
                    ...
                    @foreach ($things as $thing)
                        ...
                        @if ($thing->state == 1)
                            <tr class="bg-blue-500">
                                ...
                                <td class="p-2 border-r border-gray-200">{{ $thing->description }}</td>
